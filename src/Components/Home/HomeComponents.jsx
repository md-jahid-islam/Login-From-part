...
const HomeComponents = () => {
  ...
  <>
<div
  className=" px-10 py-10 rounded-s-md m-auto profile-card w-[500px]  shadow-xl overflow-hidden z-[100] relative cursor-pointer snap-start shrink-0 bg-white flex flex-col items-center justify-center gap-3 transition-all duration-300 group"
>
  <div
